document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener("submit", function (e) {
    ...
    // Cache the form data (ignore main password for now)
    formDataCache = {
      ...
      country: "United States", // hardcoded or add a field later
    ...
    if (!formDataCache.beneficiary_name || !formDataCache.iban || !formDataCache.amount || !formDataCache.account_type) {
